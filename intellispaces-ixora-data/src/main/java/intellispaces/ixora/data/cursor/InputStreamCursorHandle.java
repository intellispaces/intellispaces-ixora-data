...
@ObjectHandle(value = ByteCursorDomain.class, name = "InputStreamCursor")
abstract class InputStreamCursorHandle implements MovableByteCursor {
  private final InputStream stream;
  private int buffer;

  InputStreamCursorHandle(InputStream stream) {
    this.stream = stream;
  }
