...
public interface Maps {
  ...
  static <K, V> UnmovableMap<K, V> of(
    ...
    return new JavaMapHandleImpl<>(java.util.Map.of(key, value), keyClass, valueClass);
  }
  ...
  static <K, V> UnmovableMap<K, V> of(
    ...
    return new JavaMapHandleImpl<>(java.util.Map.of(key1, value1, key2, value2), keyClass, valueClass);
  }
  ...
  static <K, V> UnmovableMap<K, V> of(
    ...
    return new JavaMapHandleImpl<>(java.util.Map.of(key1, value1, key2, value2, key3, value3), keyClass, valueClass);
  }
